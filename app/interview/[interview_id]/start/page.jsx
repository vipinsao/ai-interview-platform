...
/**
 * The candidate's name and the question list are held in React context, set on
 * the join page. A refresh or a direct visit loses them, which used to render
 * a page that sat on "Interview in Progress..." forever. Now it says so and
 * links back.
 *
